...
def get_db_time():
        conn = connect("host={0} port={1} user={2} password={3} dbname={4}".format(get_db_config('db_host'), get_db_config('db_port'), get_db_config('db_name'), get_db_config('db_user'), get_db_config('db_password')))
